...
def vision_prompt(prompt,photo_path):
    ...
    prompt=(
        ...
        'to the user. Instead take the user prompt input and try to extarct all meaning from the photo'
        'relevant to the user prompt. Then generate as much objective data about the image from the AI'
...
def speak(text):
    ...
    tts_engine.setProperty('rate', 150)  # Set the speech rate
    tts_engine.setProperty('volume', 1.0)  # Set the volume (0.0 to 1.0)
